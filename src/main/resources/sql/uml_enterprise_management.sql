...
Source Database       : uml_enterprise_management

Target Server Type    : MYSQL
Target Server Version : 50720
File Encoding         : 65001

Date: 2019-11-03 17:55:18
*/
...
CREATE TABLE `t_admin` (
  ...
  `admin_username` varchar(20) NOT NULL COMMENT '管理员帐号',
  ...
  `admin_sex` varchar(4) NOT NULL COMMENT '性别',
  `admin_phone` varchar(11) NOT NULL COMMENT '手机号',
...
CREATE TABLE `t_class` (
  ...
  `class_num` varchar(16) NOT NULL COMMENT '分类编号',
  `class_name` varchar(20) NOT NULL COMMENT '分类类型',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_customer` (
  ...
  `cust_username` varchar(20) NOT NULL COMMENT '客户帐号',
  `cust_password` varchar(32) NOT NULL COMMENT '密码',
  `cust_bu_name` varchar(40) DEFAULT NULL COMMENT '公司名称',
  `cust_bu_address` varchar(40) DEFAULT NULL COMMENT '公司地址',
  `cust_bu_contactor` varchar(16) DEFAULT NULL,
  `cust_bu_introduction` varchar(255) DEFAULT NULL COMMENT '公司简介',
  `cust_bu_phone` varchar(20) DEFAULT NULL COMMENT '公司电话',
...
CREATE TABLE `t_order` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `f_key1` (`user_id`) USING BTREE,
  KEY `f_key2` (`customer_id`) USING BTREE,
...
CREATE TABLE `t_product` (
  ...
  `product_number` int(10) DEFAULT NULL COMMENT '商品数量',
  `class_id` int(16) DEFAULT NULL COMMENT '商品类型',
  `customer_id` int(16) DEFAULT NULL COMMENT '客户id',
  `product_introduce` varchar(255) DEFAULT NULL COMMENT '商品详情',
  `product_date` datetime DEFAULT NULL COMMENT '上架时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `f_key3` (`class_id`) USING BTREE,
  KEY `f_key4` (`customer_id`) USING BTREE,
...
CREATE TABLE `t_user` (
  ...
  `user_username` varchar(20) NOT NULL COMMENT '帐号名',
  `user_password` varchar(32) NOT NULL COMMENT '密码',
  `user_bu_contactor` varchar(16) DEFAULT NULL,
  `user_bu_name` varchar(40) DEFAULT NULL COMMENT '公司名称',
  `user_bu_address` varchar(40) DEFAULT NULL COMMENT '公司地址',
  `user_bu_phone` varchar(20) DEFAULT NULL COMMENT '公司电话',
